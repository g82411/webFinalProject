...
mysql_query("INSERT INTO Book (bookTitle,author,imageURL,ISBN,date,hot,resource,type,Language) VALUES 
	('".$bookTitle."','".$author."','".$imageUrl."','".$ISBN."','".date("Y-m-d")."','0','".$resource."',,'".$language."')");
?>